...
def train(
    ...
    data_path: str = "data/Thyroid_KG_data.json",
    output_dir: str = "./Thyroid_KG_r32_alpha_16_bz_256_epoch_1_llama3.1_lr_0.0003_review_ratio_0.8",
    ...
    kge_model: str = "pre_train_Thyroid_KG/Thyroid_rotate_new.pth"
):
