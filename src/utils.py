...
class BaseLLM(object):
    def __init__(self, llm_name):
        ...
        if llm_name.lower() in ['llama3.1', 'llama3']:
            self.llm_tokenizer = AutoTokenizer.from_pretrained("meta-llama/Meta-Llama-3.1-8B-Instruct",token=Token)
            self.llm_model = AutoModelForCausalLM.from_pretrained("meta-llama/Meta-Llama-3.1-8B-Instruct",token=Token, device_map='auto')
