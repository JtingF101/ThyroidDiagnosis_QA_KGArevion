...
class ReviewInfer(object):
    ...
    def read_primekg_umls(self):
        umls_to_ddb = {}
        with open('fine_tuned_model/KG_to_umls_cui.csv') as f:
            elms = pd.read_csv(f)
    ...
    def load_model(self, model, model_weights):
        ...
        # model = PeftModel.from_pretrained(model, model_weights, device_map='auto')
...
if __name__ == '__main__':
    ...
    model = ReviewInfer(llm_model, llm_tokenizer, "Thyroid_KG_r32_alpha_16_bz_256_epoch_1_llama3_lr_0.0003_review_ratio_0.2/")
